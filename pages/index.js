        ...
        <Flex direction="column" p={15} rounded={20} background={formBackground}>
          <Tabs align="center" variant="solid-rounded" colorScheme="twitter">
            <TabList>
              ...
              <Button ml={2} onClick={toggleColorMode} _focus={{ boxShadow: 'none' }}>
                {iconMode}
              </Button>
            </TabList>
            ...
            <TabPanels>
              <TabPanel>
                ...
                <Text fontSize="1.2rem">
                  A <span color="#000">Front-End</span> developer
                </Text>
              ...
              <TabPanel>
                <h4>Hello! My name is Vladimir and I am FrontEnd Dev (Junior)</h4>- <b>Languages</b>
                : RussianNative, EnglishPreIntermediate
                <br />- <b>Hobby</b>: Astronomy, Physics, Chess
              </TabPanel>
            </TabPanels>
          </Tabs>
        </Flex>
